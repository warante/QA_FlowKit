...
test('stable release config record is prepared while active policy remains rc', async () => {
...
test('stable policy helpers distinguish rc active from prepared stable file', () => {
  const active = { prerelease: true, 'prerelease-type': 'rc', packages: { '.': {} } };
