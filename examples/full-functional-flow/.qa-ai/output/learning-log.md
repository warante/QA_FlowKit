...
| ----------- | ----------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------- | ----------------- | -------- |
| LRN-001     | review      | RF-501    | Registration flow has 6 CAs but email delivery is inherently manual. Consider adding a mock email server for automated verification.                | Add guidance to test-data-agent.md about email mocking strategies | .qa-ai/agents/test-data-agent.md                  | yes               | proposed |
