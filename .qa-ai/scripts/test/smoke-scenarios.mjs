...
export async function runSmokeScenarios({ copyFramework, run }) {
  ...
  try {
    ...
    const unexpectedDefaultPaths = [
      ...
      ARTIFACT_PATHS.testManagementMapping
    ];
    ...
    const expectedOptionalDocPaths = [
      ARTIFACT_PATHS.requirementAnalysis,
      ARTIFACT_PATHS.sourceAnalysis,
      ARTIFACT_PATHS.testDesignSystem,
      ARTIFACT_PATHS.testDesignProposal,
      ARTIFACT_PATHS.traceabilityMatrix,
      ARTIFACT_PATHS.testManagementMapping
    ];
