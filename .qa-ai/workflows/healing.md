...
1. Read `AGENTS.md`, `qa-ai.config.yaml`, `.qa-ai/rules/automation.rules.md` and `.qa-ai/agents/test-healing-agent.md`.
...
1. Leer `AGENTS.md`, `qa-ai.config.yaml`, `.qa-ai/rules/automation.rules.md` y `.qa-ai/agents/test-healing-agent.md`.
