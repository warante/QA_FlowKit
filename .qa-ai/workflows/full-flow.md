...
4. Produce or update `qa-ai-output/testrail-coverage-analysis.md`.
5. Produce `qa-ai-output/test-design-proposal.md` and ask approval before creating `.feature` files.
...
8. Produce or update `qa-ai-output/testrail-sync-plan.md`; do not write to external test management tools in the MVP.
9. Update `qa-ai-output/traceability-matrix.md`.
10. Produce or update `qa-ai-output/automation-feasibility-report.md`.
11. Produce `qa-ai-output/automation-implementation-plan.md` and ask approval before automation code changes.
12. Implement only approved automation changes using repository conventions.
13. Prepare `qa-ai-output/pr-summary.md` with traceability, execution status and residual risk.
